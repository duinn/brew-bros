...
import com.duinn.brewbros.config.audit.AuditEventConverter;
import com.duinn.brewbros.domain.PersistentAuditEvent;
...
import static com.duinn.brewbros.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
